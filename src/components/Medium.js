...
function MediumCard({ id, img, title, currency, cost, stayType, bedrooms, bathrooms }) {
            ...
            <div className="flex items-center justify-center ">
                <div className="max-w-sm w-full  py-6 px-3">
                    <div className="bg-white shadow-xl rounded-lg overflow-hidden">
                        <div className="bg-cover bg-center h-56 p-4" style={{ backgroundImage: `url(${img})` }}>
                        ...
                        <div className="p-4">
                            <p className="uppercase tracking-wide text-sm font-bold text-gray-700">{stayType}</p>
                            <p className="text-3xl text-gray-900">{currency}{cost}</p>
