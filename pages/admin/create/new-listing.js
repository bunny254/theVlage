...
const NewListing = () => {
    ...
    const { listing_type, location, building_type, property_name, description, unit_size, cove_image, stay_type, is_furnished, utilities_cost, rent_cost, currency, available_from, bathrooms, bedrooms, amenities, latitude, longitude, loading, errors, success } = formData
    ...
    const handlePlaceChange = item => {
        console.log(item);
        setFormData({ ...formData, errors: '', location: item.place_name, longitude: item.geometry.coordinates[0], latitude: item.geometry.coordinates[1] })
    ...
    const submit = async (e) => {
        ...
        const newListing = { listing_type, building_type, property_name, description, location, unit_size, stay_type, cover_image, is_furnished, utilities_cost, rent_cost, currency, bathrooms, bedrooms, amenities, latitude, longitude, available_from }
