    ...
    const accordionData = [
        {
            ...
            content: `Coliving is a living/housing model where a group of people share an apartment or house and share the communal areas such as kitchen, living room but have their own private bedrooms.
Booking process
Our booking process is very easy. You just review properties and choose a suitable property, then you sign up by creating an account. Once the account is verified, you can now complete your booking process and pay. A receipt is sent to your email for confirmation with additional details regarding your booking. 
Documents required; Your ID Number and a passport photo or selfie. You will also submit your email address, and phone number for a successful sign up.
Roommate matching 
When will we introduce it? Our match making feature is coming soon, early 2022.
How will it work? We shall match people with similar interests using matchmaking algorithms and AI. 
How will costs be split?It's free of charge to match with a roommate.
Vetting- We use third KYC services to vet our platform users,
Long vs short term stays. A long term stay is considered 6-12} Months of stay, Medium Stay 1-5 Months and short stay 1-30 days. 
Refunds and cancellations. All successful bookings can be cancelled in advance before moving in. A refund is done for advance cancellation. However, there are instances where tenants are not eligible for a refund. Kindly read our T&Cs for more details`
        },
        {
            title: 'How do you ensure that I get a good roommate and I am safe?',
            content: `We do our due diligence for all our customers. Through our matchmaking API we are able to ensure you have a suitable roommate who matches your personality, likes and dislikes.`

        },
        {
            title: 'If I make a booking and have paid and an unexpected event hinders my moving in the space can I get a refund?',
            content: `Read our refund policy for more details.`

        },
        {
            title: 'Why do I need to pay a deposit?',
            content: `Deposit is only applicable to long term customers.The deposit is used as security by the host so that they can pay for any damages or loss of household items during your stay.`

        },
        {
            title: 'How does the Vlage ensure that my roommates abide by certain rules?',
            content: `All our customers MUST observe the rules and regulations as stated in the terms and conditions. In addition each host may have additional house rules which the customers need to abide by. If a customer continues to disturb roommates and a formal complaint is lodged then the customer will unfortunately be removed from the coliving space.
`

        },
        {
            title: 'How do you verify customers staying at my property?',
            content: `At the Vlage we conduct our due diligence for every customer. The host is also at liberty  to conduct their own due diligence of the people living in their spaces.
`

        },
        {
            title: 'Does my  property need to be insured?',
            content: `Yes you need to insure your property from at least  theft and fire `
    ...
    return (
        <div>
            <Navbar />
            <main>
                <section class="rounded-2xl bg-indigo-800 mx-5 my-3 text-gray-600 body-font">
                    <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                        <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
                            <div className="flex flex-col items-start mt-2 pt-2">
                                <ol className="inline-flex items-start space-x-1 md:space-x-3">
                                    <li className="inline-flex items-center">
                                        <a href="#" className="text-white hover:text-gray-200 font-normal inline-flex items-center">
                                            Home
                                        </a>
                                    </li>
                                    <li>
                                        <div className="flex items-center">
                                            ...
                                            <a href="#" className="text-white hover:text-gray-200 font-normal inline-flex items-center">FAQ</a>
                                        </div>
                                    </li>

                                </ol>
                                <h1 className='title-font text-4xl my-3 font-medium text-white'>
                                    FAQ
                                </h1>
                        ...
                        <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                            ...
                            <p class="mb-8 font-semibold text-gray-300 leading-relaxed">Frequently asked questions</p>
